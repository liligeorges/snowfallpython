...
loginDict = {'Gerald': '4d416525fcdbdd87be5b3cda134e806dfa6613c682fb8b749ea552adeffab251', 
			...
			#ABC
#we have to create a function that will convert the hashed text into a password
def makeHash(password):
    return sha256(password.encode('utf-8')).hexdigest()
#checks to see if user is signed up and their username
...
for first in letters:
	for second in letters:
		for third in letters:
			...
			hash = sha256(total.encode('utf-8')).hexdigest() 
			find = "4d416525fcdbdd87be5b3cda134e806dfa6613c682fb8b749ea552adeffab251"		
			if hash == find:
				print (total)